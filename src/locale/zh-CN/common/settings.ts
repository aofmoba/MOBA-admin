export default {
  ...
  'settings.copy.succ': '复制成功',
  'settings.chain.fuji': '切换到Fuji，查看更多信息哦',
  'settings.chain.msg': '切换到BSC 或 CSC网络，查看更多信息哦',
  'settings.chain.msg2': '切换到Fuji 或 BSC 网络，查看申购信息哦',
  'settings.chain.succ': '切换成功',
  'settings.chain.err': '切换失败',
};
