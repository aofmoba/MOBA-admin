export default {
  ...
  'settings.copy.succ': 'Copy successful',
  'settings.chain.fuji': '切换到Fuji，查看更多信息哦',
  'settings.chain.msg': 'Switch to BSC or CSC network to see more information',
  'settings.chain.msg2': 'Switch to Fuji or BSC network to view subscription information',
  'settings.chain.succ': 'Switch successful',
  'settings.chain.err': 'Switch failed',
};
